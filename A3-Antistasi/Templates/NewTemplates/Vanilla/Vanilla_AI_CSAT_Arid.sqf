...
_sfLoadoutData setVariable ["backpacks", ["B_AssaultPack_ocamo", "B_TacticalPack_ocamo", "B_Carryall_ocamo"]];			//this line determines backpacks for special forces -- Example: ["B_AssaultPack_mcamo", "B_Kitbag_mcamo"] -- Array, can contain multiple assets
...
["arifle_Katiba_C_F", "muzzle_snds_H", "acc_pointer_IR", "optic_Holosight_blk_F", [], [], ""],
["arifle_Katiba_C_F", "muzzle_snds_H", "acc_pointer_IR", "optic_Arco_blk_F", [], [], ""],
["arifle_Katiba_C_F", "muzzle_snds_H", "acc_pointer_IR", "optic_Arco", [], [], ""],
...
["LMG_Mk200_F", "muzzle_snds_H_MG", "acc_pointer_IR", "optic_Holosight", [], [], "bipod_01_F_blk"],
...
_militaryLoadoutData setVariable ["backpacks", ["B_TacticalPack_ocamo", "B_Carryall_ocamo", "B_Bergen_hex_F"]];		//this line determines backpacks for military loadouts -- Example: ["B_AssaultPack_mcamo", "B_Kitbag_mcamo"] -- Array, can contain multiple assets
...
_militiaLoadoutData setVariable ["backpacks", ["B_FieldPack_oucamo", "B_Carryall_oucamo"]];		//this line determines backpacks for militia loadouts -- Example: ["B_AssaultPack_mcamo", "B_Kitbag_mcamo"] -- Array, can contain multiple assets
_militiaLoadoutData setVariable ["helmets", ["H_HelmetO_oucamo", "H_HelmetLeaderO_oucamo", "H_MilCap_gry"]];		//this line determines helmets for police loadouts -- Example: ["H_HelmetB_camo", "H_HelmetB_desert"] -- Array, can contain multiple assets
...
private _atTemplate = {
	...
	[selectRandom ["lightATLaunchers", "missileATLaunchers"]] call _fnc_addLauncher;
	//TODO - Add a check if it's disposable.

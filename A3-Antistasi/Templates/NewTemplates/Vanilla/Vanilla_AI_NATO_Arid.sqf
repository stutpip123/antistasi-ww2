...
["baggedAT", ["B_HMG_01_support_F","B_AT_01_weapon_F"]] call _fnc_saveToTemplate; 					//this line determines bagged static ATs -- Example: ["baggedAT", [["B_static_AT_F", "B_HMG_01_support_F"]]] -- Array, can contain multiple assets
["baggedAA", ["B_HMG_01_support_F","B_AA_01_weapon_F"]] call _fnc_saveToTemplate; 					//this line determines bagged static ATs -- Example: ["baggedAT", [["B_static_AT_F", "B_HMG_01_support_F"]]] -- Array, can contain multiple assets
["baggedMortars", ["B_Mortar_01_support_F","B_Mortar_01_weapon_F"]] call _fnc_saveToTemplate; 			//this line determines bagged static mortars -- Example: ["baggedMortars", [["B_Mortar_01_F", "B_Mortar_01_support_F"]]] -- Array, can contain multiple assets
...
_loadoutData setVariable ["rifles", ["arifle_MX_F","arifle_MX_ACO_pointer_F","arifle_MX_Holo_pointer_F","arifle_MX_Hamr_pointer_F"]]; 					//this line determines rifles -- Example: ["arifle_MX_F","arifle_MX_pointer_F"] -- Array, can contain multiple assets
_loadoutData setVariable ["carbines", ["arifle_MXC_F","arifle_MXC_Holo_F"]]; 					//this line determines carbines -- Example: ["arifle_MXC_F","arifle_MXC_Holo_F"] -- Array, can contain multiple assets
_loadoutData setVariable ["grenadeLaunchers", ["arifle_MX_GL_F","arifle_MX_GL_ACO_pointer_F","arifle_MX_GL_Hamr_pointer_F"]]; 			//this line determines grenade launchers -- Example: ["arifle_MX_GL_ACO_F","arifle_MX_GL_ACO_pointer_F"] -- Array, can contain multiple assets
_loadoutData setVariable ["SMGs", ["SMG_01_F","acc_flashlight_smg_01","optic_holosight"]]; 						//this line determines SMGs -- Example: ["SMG_01_F","SMG_01_Holo_F"] -- Array, can contain multiple assets
_loadoutData setVariable ["machineGuns", ["arifle_MX_SW_F","arifle_MX_SW_Hamr_pointer_F"]]; 				//this line determines machine guns -- Example: ["arifle_MX_SW_F","arifle_MX_SW_Hamr_pointer_F"] -- Array, can contain multiple assets
_loadoutData setVariable ["marksmanRifles", ["arifle_MXM_F","arifle_MXM_Hamr_pointer_F"]]; 			//this line determines markman rifles -- Example: ["arifle_MXM_F","arifle_MXM_Hamr_pointer_F"] -- Array, can contain multiple assets
_loadoutData setVariable ["sniperRifles", ["srifle_LRR_camo_F","srifle_LRR_camo_SOS_F"]]; 				//this line determines sniper rifles -- Example: ["srifle_LRR_camo_F","srifle_LRR_camo_SOS_F"] -- Array, can contain multiple assets
_loadoutData setVariable ["lightATLaunchers", ["launch_MRAWS_sand_rail_F","launch_MRAWS_sand_F"]]; 			//this line determines light AT launchers -- Example: ["launch_NLAW_F"] -- Array, can contain multiple assets
...
_loadoutData setVariable ["sidearms", ["hgun_P07_F"]]; 					//this line determines handguns/sidearms -- Example: ["hgun_Pistol_heavy_01_F", "hgun_P07_F"] -- Array, can contain multiple assets
...
_sfLoadoutData setVariable ["backpacks", ["B_AssaultPack_khk","B_Carryall_cbr"]];			//this line determines backpacks for special forces -- Example: ["B_AssaultPack_mcamo","B_Kitbag_mcamo"] -- Array, can contain multiple assets
...
_militaryLoadoutData setVariable ["backpacks", ["B_Carryall_cbr","B_Kitbag_rgr","B_AssaultPack_rgr"]];		//this line determines backpacks for military loadouts -- Example: ["B_AssaultPack_mcamo","B_Kitbag_mcamo"] -- Array, can contain multiple assets

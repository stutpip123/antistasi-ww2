...
["vehiclesAmphibious", ["rhsusf_m113d_usarmy", "rhsusf_m113d_usarmy_M240", "rhsusf_m113d_usarmy_MK19", "rhsusf_m113d_usarmy_unarmed"]] call _fnc_saveToTemplate; 		//this line determines amphibious vehicles  -- Example: ["vehiclesAmphibious", ["B_APC_Wheeled_01_cannon_F"]] -- Array, can contain multiple assets
...
["vehiclesHelisTransport", ["RHS_UH60M_d", "RHS_UH60M_ESSS_d", "RHS_UH60M_ESSS2_d", "RHS_UH60M2_d", "RHS_CH_47F_light"]] call _fnc_saveToTemplate; 	//this line determines transport helis -- Example: ["vehiclesHelisTransport", ["B_Heli_Transport_01_F"]] -- Array, can contain multiple assets
["vehiclesHelisAttack", ["RHS_MELB_AH6M", "RHS_MELB_AH6M_M", "RHS_MELB_AH6M_H", "RHS_AH64D","RHS_AH64D_CS","RHS_AH64D_AA"]] call _fnc_saveToTemplate; 		//this line determines attack helis -- Example: ["vehiclesHelisAttack", ["B_Heli_Attack_01_F"]] -- Array, can contain multiple assets
...
["pvpVehicles", ["rhsusf_m1025_d_s","rhsusf_m998_d_s_2dr","rhsusf_m998_d_s_2dr_fulltop","rhsusf_m998_d_s_4dr","rhsusf_m1025_d_s_m2","rhsusf_mrzr4_d_mud","rhsusf_m1240a1_m240_usmc_d"]] call _fnc_saveToTemplate; 				//this line determines the vehicles PvP players can spawn in -- Example: ["pvpVehicles", ["B_MRAP_01_F", "B_MRAP_01_hmg_F"]] -- Array, can contain multiple assets
...
_militaryLoadoutData setVariable ["backpacks", ["rhsusf_assault_eagleaiii_ocp", "B_TacticalPack_mcamo", "B_Kitbag_mcamo", "B_Carryall_mcamo", "rhsusf_falconii_mc"]];		//this line determines backpacks for military loadouts -- Example: ["B_AssaultPack_mcamo", "B_Kitbag_mcamo"] -- Array, can contain multiple assets
...
["rhs_weap_m4a1_carryhandle", "rhsusf_acc_SF3P556", "rhsusf_acc_anpeq16a", "rhsusf_acc_ACOG", [], [], "rhsusf_acc_grip3"],
["rhs_weap_m4a1_carryhandle", "rhsusf_acc_SF3P556", "rhsusf_acc_anpeq16a", "rhsusf_acc_ACOG_RMR", [], [], "rhsusf_acc_grip3"]
]];
...
["rhs_weap_m4a1_carryhandle_m203", "rhsusf_acc_SF3P556", "rhsusf_acc_anpeq16a", "rhsusf_acc_ACOG", [], [], ""],
["rhs_weap_m4a1_carryhandle_m203", "rhsusf_acc_SF3P556", "rhsusf_acc_anpeq16a", "rhsusf_acc_ACOG_RMR", [], [], ""],
["rhs_weap_m4a1_carryhandle_m203", "rhsusf_acc_SF3P556", "rhsusf_acc_anpeq16a", "rhsusf_acc_eotech_552", [], [], ""],
["rhs_weap_m4a1_carryhandle_m203", "rhsusf_acc_SF3P556", "rhsusf_acc_anpeq16a", "rhsusf_acc_compm4", [], [], ""],
["rhs_weap_m4a1_carryhandle_m203", "rhsusf_acc_SF3P556", "rhsusf_acc_anpeq16a", "rhsusf_acc_T1_high", [], [], ""],
["rhs_weap_m4a1_carryhandle_m203", "rhsusf_acc_SF3P556", "rhsusf_acc_anpeq16a", "rhsusf_acc_eotech_xps3", [], [], ""]
]];
...
private _squadLeaderTemplate = {
	...
	[["SLvests", "vests"] call _fnc_fallback] call _fnc_addVest;
	["uniforms"] call _fnc_addUniform;
	//TODO - Long range radios
	[["longRangeRadios", "backpacks"] call _fnc_fallback] call _fnc_addBackpack;

	[["grenadeLaunchers", "rifles", "shotgun"] call _fnc_fallback] call _fnc_addPrimary;
...
private _medicTemplate = {
	["helmets"] call _fnc_addHelmet;
	[["MEDvests", "vests"] call _fnc_fallback] call _fnc_addVest;
	["uniforms"] call _fnc_addUniform;
	["backpacks"] call _fnc_addBackpack;
...
private _grenadierTemplate = {
	["helmets"] call _fnc_addHelmet;
	[["GLvests", "vests"] call _fnc_fallback] call _fnc_addVest;
	["uniforms"] call _fnc_addUniform;
	["backpacks"] call _fnc_addBackpack;
	...
	[["GLsidearms", "sidearms"] call _fnc_fallback] call _fnc_addHandgun;
	["handgun", 2] call _fnc_addMagazines;
...
private _machineGunnerTemplate = {
	["helmets"] call _fnc_addHelmet;
	[["MGvests", "vests"] call _fnc_fallback] call _fnc_addVest;
	["uniforms"] call _fnc_addUniform;
	["backpacks"] call _fnc_addBackpack;
...
private _sniperTemplate = {
	["helmets"] call _fnc_addHelmet;
	[["SNIvests", "vests"] call _fnc_fallback] call _fnc_addVest;
	["uniforms"] call _fnc_addUniform;
	["backpacks"] call _fnc_addBackpack;
...
private _policeTemplate = {
	...
	[selectRandom ["SMGs", "shotgun"]] call _fnc_addPrimary;
	["primary", 5] call _fnc_addMagazines;
...
private _crewTemplate = {
	...
	[["SMGs", "carbines"] call _fnc_fallback] call _fnc_addPrimary;

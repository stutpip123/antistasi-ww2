...
jnl_allowedWeapons append [
  //GAZ-66
  ["\rhsafrf\addons\rhs_gaz66\rhs_gaz66.p3d", jnl_largeVicWeapons]
];
...
["\rhsafrf\addons\rhs_heavyweapons\spg9\spg9.p3d",			         	[-0.5, 0, 0.00], 	   	[-0.97,0.26,0],  	0],		//RHS SPG-9, facing 75 degrees to the left
["\rhsafrf\addons\rhs_heavyweapons\AGS30\AGS_static",		         	[-0.3, 0, 1.20],	   	[0.94,-0.34,0],	  0],		//RHS AGS-30 the russian GMG, facing right

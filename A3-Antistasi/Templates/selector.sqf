...
if(teamplayer != independent) then {//This section is for Altis Blufor ONLY!
  ...
  switch(true) do{
    ...
    case (hasTIOW): {
      switch(true) do {
        default {
          call compile preProcessFileLineNumbers "Templates\TIOW_Civ.sqf";
          call compile preProcessFileLineNumbers "Templates\TIOW_Reb_RENE_Arid.sqf";
          call compile preProcessFileLineNumbers "Templates\TIOW_Occ_IOM_Arid.sqf";
          call compile preProcessFileLineNumbers "Templates\TIOW_Inv_ORK_Arid.sqf";
        };
      };
      call compile preProcessFileLineNumbers "Templates\TIOW_Civ.sqf";
    };

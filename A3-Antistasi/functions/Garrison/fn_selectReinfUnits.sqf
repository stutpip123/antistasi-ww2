...
[3, format ["Gathered data for unit selection, available are %1, %3 cargo units needed", _pointsAvailable, _maxCargoSpaceNeeded], _fileName] call A3A_fnc_log;
[3, format ["Reinforcements requested from %1 for: %2", _target, _reinf], _fileName] call A3A_fnc_log;

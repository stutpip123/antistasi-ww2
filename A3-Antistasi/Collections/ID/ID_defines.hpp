...
// Col_ID_UUID_G1e3's limit is shorten length. It will not be run fast enough to become depleted in a millisecond (alone = 833 KHz, with systemTimeUTC = 303 KHz, a 3x speed boost would be required.).
